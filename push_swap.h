...
/*                                                   +#+                      */
/*   Created: 2021/10/08 09:30:36 by jmurovec      #+#    #+#                 */
/*   Updated: 2021/10/08 09:30:39 by jmurovec      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	push_a(int x, int *box_a, int *box_b, t_boxes *box);
void	push_b(int x, int *box_a, int *box_b, t_boxes *box);
